...
- Real pivot tables (DataPilot)
- Charts (bar, line, pie, area, scatter)
- Conditional formatting (colors, icons, traffic lights)
- Data validation (dropdowns, number ranges)
- Professional themes (corporate, analysis, presentation)
...
Automatically detected from LibreOffice locale. If not supported, defaults to English.
